...
export default function SitePolicy({ kind }: { kind: "privacy" | "terms" }) {
  ...
  const sections = privacy
    ? [
        ...
        [
          "How it is used",
          "Information is used to provide requested downloads and access links, process and support orders, respond to inquiries, maintain subscription preferences, and protect the website against abuse. Claiming a download or making an inquiry does not automatically subscribe you to the marketing newsletter. Newsletter signup is a separate choice with a confirmation step; unsubscribe links are included in newsletter emails.",
        ],
        [
  ...
  return (
    <InformationPage
      ...
      intro={`${privacy ? "How information from this website is handled" : "What to know when using this website and its resources"}. Updated September 19, 2026.`}
    >
