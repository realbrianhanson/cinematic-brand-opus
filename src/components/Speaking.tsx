    ...
    <div
      ...
      style={{
        ...
        transform: visible
          ...
          : "translateY(30px)",
        opacity: visible ? 1 : 0,
        transition: `all 0.5s cubic-bezier(0.22,1,0.36,1) ${index * 0.08}s`,
      }}
    ...
    <div className="relative mx-auto px-6 lg:px-14" style={{ maxWidth: 1440 }}>
      <div className="grid lg:grid-cols-12 gap-16 lg:gap-20">
        ...
        <div className="lg:col-span-7">
          ...
          <h2 className="font-display mb-5" style={{ fontSize: "clamp(2.2rem, 4.5vw, 3.8rem)", lineHeight: 1.08, color: "#fff" }}>
            Bring Brian{" "}
            <em style={{
              fontStyle: "italic",
          ...
          <p className="font-body mb-12" style={{ fontSize: "1.05rem", lineHeight: 1.7, color: "rgba(255,255,255,0.45)", maxWidth: 520 }}>
