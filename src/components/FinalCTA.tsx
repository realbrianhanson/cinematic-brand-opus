  ...
  return (
    <section id="contact" className="relative py-32 lg:py-40" style={{ background: "#07070E" }}>
      ...
      <div className="relative mx-auto px-6 lg:px-14 max-w-2xl text-center">
        <h2 className="font-display mb-5" style={{ fontSize: "clamp(2rem, 4.5vw, 3.5rem)", lineHeight: 1.1, color: "#fff" }}>
          Ready for Your{" "}
          <em style={{
            fontStyle: "italic",
        ...
        <p className="font-body mb-10" style={{ fontSize: "1.05rem", lineHeight: 1.7, color: "rgba(255,255,255,0.45)" }}>
